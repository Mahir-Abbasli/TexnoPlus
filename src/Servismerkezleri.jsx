      ...
      <div className='filiallar_div'>
        <div className='filiallar_kicik_div_part'>
          <div className='filiallar_kicik_div'>
            <span className='adi_filial'>Nerimanov filialı</span>
            <span className='adres_filial'> Nərimanov Rayonu, Əhməd Rəcəbli 50C</span>
            <span className='is_saati_filial'>İş saatı: 09:00-18:00</span>
          ...
          <div className='filiallar_kicik_div'>
            ...
            <span className='adres_filial'>Bakı şəhəri, Xətai r-nu <br />M.Hadi küç 41Y</span>
            <span className='is_saati_filial'>İş saatı: 10:00-21:00</span>
            <span className='tel_filial'>Tel: (+994 12) 478 98 60</span>
            <span className='mob_filial'>Mob: (+994 50) 977 11 81</span>
          </div>
          <div className='filiallar_kicik_div'>
            <span className='adi_filial'>Mərkəz filialı</span>
            <span className='adres_filial'>Bakı şəhəri, Azadlıq pr-ti 202f</span>
            <span className='is_saati_filial'>İş saatı: 10:00-21:00</span>
            <span className='tel_filial'>Tel: (+994 12) 478 98 60</span>
            <span className='mob_filial'>Mob: (+994 50) 977 11 81</span>
          </div>
          <div className='filiallar_kicik_div'>
            <span className='adi_filial'>Abşeron filialı</span>
            <span className='adres_filial'>Bakı şəhəri, M.Rəsulzadə ev 10</span>
            <span className='is_saati_filial'>İş saatı: 10:00-21:00</span>
            <span className='tel_filial'>Tel: (+994 12) 478 98 60</span>
            <span className='mob_filial'>Mob: (+994 50) 977 11 81</span>
          </div>
...
export default Servismerkezleri;
